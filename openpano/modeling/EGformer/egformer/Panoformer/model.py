...
class Panoformer(nn.Module):
    def __init__(self, img_size=256, in_chans=3,
        ...
        self.mlp = token_mlp
        self.win_size = win_size
        self.ref_point256x512 = genSamplingPattern(128, 256, 3, 3).cuda()#torch.load("network6/Equioffset256x512.pth")
        self.ref_point128x256 = genSamplingPattern(64, 128, 3, 3).cuda()#torch.load("network6/Equioffset128x256.pth")
        self.ref_point64x128 = genSamplingPattern(32, 64, 3, 3).cuda()#torch.load("network6/Equioffset64x128.pth")
        self.ref_point32x64 = genSamplingPattern(16, 32, 3, 3).cuda()##torch.load("network6/Equioffset32x64.pth")
        self.ref_point16x32 = genSamplingPattern(8, 16, 3, 3).cuda()#torch.load("network6/Equioffset16x32.pth")
