...
class HoHoNet(nn.Module):
    def __init__(self, model_cfg):
        ...
        decode_config = model_cfg["decode_config"]
        refine_config = model_cfg["refine_config"]
        upsample_config = model_cfg["upsample_config"]
        modalities_config = model_cfg["modalities_config"]
        ...
        Encoder_kwargs = backbone_config["kwargs"]
        ...
        Refinement_kwargs = refine_config['kwargs']
